...
INSERT INTO `account` (`id`, `username`, `password`, `teacher_id`, `status`) VALUES
	...
	(28, 'a2madmin', '$2a$10$sYY5hJvnfXc/pfcCXd2RoOv9TCY9HEZ/oivs.dPPMcK5ScqNAEStK', 6, b'1'),
...
-- Dumping data for table education.class: ~10 rows (approximately)
...
-- Dumping data for table education.images: ~7 rows (approximately)
/*!40000 ALTER TABLE `images` DISABLE KEYS */;
INSERT INTO `images` (`id`, `stu_id`, `parent_id`, `teacher_id`, `file_type`, `size`, `filename`, `location`) VALUES
	(3, NULL, 1, NULL, 'image/png', 148599, '123.png', 'http://localhost:9090/synap_upload/123.png'),
	(4, NULL, 31, NULL, 'image/jpeg', 1510052, '1.jpg', 'http://localhost:9090/synap_upload/1.jpg'),
	(10, NULL, 2, NULL, 'image/jpeg', 1510052, '2c5ee25ec-a076-4ffa-8ad1-9e0292b08836.jpg', 'http://localhost:9090/synap_upload/2c5ee25ec-a076-4ffa-8ad1-9e0292b08836.jpg'),
	(11, 2, NULL, NULL, 'image/png', 3684, '2f66e7b14-2273-4468-9f59-75ab484214d1.jpg', 'http://localhost:9090/synap_upload/2f66e7b14-2273-4468-9f59-75ab484214d1.jpg'),
	(16, 1, NULL, NULL, 'image/jpeg', 1510052, '1333ad10c-bf98-4942-a4c0-aaf53ddaaf8d.jpg', 'http://localhost:9090/synap_upload/1333ad10c-bf98-4942-a4c0-aaf53ddaaf8d.jpg'),
	(17, 54, NULL, NULL, 'image/png', 3684, '54987931fd-afd8-453c-8f0c-695a92ad933c.jpg', 'http://localhost:9090/synap_upload/54987931fd-afd8-453c-8f0c-695a92ad933c.jpg'),
	(18, 55, NULL, NULL, 'image/jpeg', 1510052, '55d9582ea5-cbff-4911-b9a5-c55c7788379a.jpg', 'http://localhost:9090/synap_upload/55d9582ea5-cbff-4911-b9a5-c55c7788379a.jpg'),
	(19, 56, NULL, NULL, 'image/png', 148599, '5600e53710-68e4-4f67-8b47-1f46d1f0597c.jpg', 'http://localhost:9090/synap_upload/5600e53710-68e4-4f67-8b47-1f46d1f0597c.jpg');
...
INSERT INTO `parent` (`id`, `parent_name`, `birthday`, `gender`, `address`, `telephone`, `email`, `status`) VALUES
	...
	(19, 'Nguyễn Văn Giang', '1972-06-13', 'Nam', 'Hà Nội', '0344234422', 'addadada@gmail.com', 'Hoạt động'),
	...
	(28, 'Nguyễn Văn Long', '1974-06-02', 'Nam', 'Hà Nội', '0344234422', 'addadada@gmail.com', 'Hoạt động'),
	(29, 'Lê Hoàng Hà', '1973-05-06', 'Nam', '2020-2021', '222222222', 'aaaa@gmail.com', 'Hoạt động'),
	(31, 'Nguyễn Văn Long', '1977-07-02', 'Nam', 'Hà Nội', '0344234422', 'addadada@gmail.com', 'Hoạt động');
...
-- Dumping data for table education.student: ~7 rows (approximately)
...
INSERT INTO `student` (`id`, `stu_name`, `birthday`, `gender`, `address`, `admission_date`, `status`) VALUES
	...
	(53, 'Nguyễn Văn Trỗi', '2016-05-11', 'Nam', 'Hà Nội', '2021-08-16', 'Đang học'),
	(54, 'Lê Hoàng Long', '2016-06-15', 'Nam', 'Địa chỉ', '2021-08-26', 'Đang học'),
	(55, 'Nguyễn Bá Nhật', '2016-07-11', 'Nam', 'Hà Nội', '2021-08-26', 'Đang học'),
	(56, 'Dương Minh Thông', '2016-01-11', 'Nam', 'Hà Nội', '2021-08-26', 'Đang học');
...
-- Dumping data for table education.student_has_parent: ~6 rows (approximately)
...
-- Dumping data for table education.subclass_diary: ~16 rows (approximately)
...
INSERT INTO `teacher` (`id`, `teacher_name`, `birthday`, `gender`, `level`, `subject_id`, `graduation_year`, `address`, `telephone`, `email`, `work_start_date`, `status`) VALUES
	...
	(6, 'Cao Thanh Vinh', '1990-01-20', 'Nữ', 'Tiến sĩ', 2, '1995', 'Hà Nội', '098454321', 'caothanhvinh@gmail.com', '2016-08-18', 'Hoạt động'),
	...
	(11, 'Đào Văn Dương', '1990-08-23', 'Nam', 'Đại học', 3, '1995', 'Hà Nội', '097878555', 'daovanduong@gmail.com', '2021-02-23', 'Hoạt động');
